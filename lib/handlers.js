...
exports.get = function() {
  ...
  return function(req, res, next, params) {
    console.log("Emitting before.get");
    self.emit("before.get", req, res);
    console.log("GET on " + self.resourceName);
    req.quer.lean().exec(function(err, list) {
      self.emit("after.get", req, res, list);
      if (err)
...
exports.put = function() {
  ...
  return function(req, res, next, filters) {
    ...
    exports.requireOneModel.call(self, res, req.quer, function(err, newObj) {
      self.emit('after.put', req, res, newObj);
      if (err) {
...
exports.delete = function() {
  var self = this;
  return function(req, res, next, params) {
    self.emit('before.delete', req, res);
    ...
    exports.requireOneModel.call(self, res, req.quer, function(err, obj) {
      self.emit('after.delete', req, res, obj);
...
exports.wrap = function(handler, detail) {
  if (detail) {
    return function(req, res, next) {
      exports.requireOneModel.call(this, res, req.quer, function(err, model) {
        handler(req, res, next, err, model);
      });
    }
  }
  return handler;
